...
module.exports = async (req, res) => {
    ...
    // what if I pass '2'? or '-123'? Strange conversions from string?
    ...
    if(review == 1){
        ...
        const items = await nodeQueries.selectForReview(searchstring, resultLimit);
        ...
        const items = await nodeQueries.selectDatesAndLikeString(searchstring, resultLimit, todaysDate, todaysDate, order);
        ...
        const items = await nodeQueries.selectDatesAndLikeString(searchstring, resultLimit, fromdate, todate, order);
        //console.log(items);
        ...
        const items = await nodeQueries.selectAllLikeString(searchstring, resultLimit, order);
